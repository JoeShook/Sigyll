...
try
{
    ...
    builder.Services.AddHttpClient("SigyllCrl");
    ...
    builder.Services.AddScoped<Sigyll.UI.Services.TimeDisplayService>();
    builder.Services.AddScoped<Sigyll.UI.Services.IssuancePasswordCache>();
    ...
    builder.Services.AddHangfire(config => config
        ...
        .UsePostgreSqlStorage(options =>
            options.UseNpgsqlConnection(builder.Configuration.GetConnectionString("SigyllDb")),
    ...
    {
        var db = scope.ServiceProvider.GetRequiredService<SigyllDbContext>();
...
static async Task SeedDidTemplatesAsync(SigyllDbContext db)
{
...
static async Task SeedCredentialSchemasAsync(SigyllDbContext db)
{
