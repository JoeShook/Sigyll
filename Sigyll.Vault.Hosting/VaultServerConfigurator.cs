...
namespace Sigyll.Vault.Hosting;
...
internal static class VaultServerConfigurator
{
        ...
        CancellationToken ct)
    {
        ...
        // 4. Ensure the well-known root token alias exists (lets Sigyll keep using "root-token")
        ...
        ILogger logger, CancellationToken ct)
    {
        ...
        if (!createResponse.IsSuccessStatusCode)
        {
            ...
            logger.LogWarning(
                ...
                "Sigyll will need to use the actual root token ({ActualToken})",
